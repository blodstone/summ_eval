<template>
    <div class="document">
        ...
        <hr/>
        <h5>Fluency Example</h5>
        <p><strong>Sentence that isn’t fluent (grammatical error, does not sound natural):</strong></p>
        <p><em>
            “officials from iaea and the european conventions were suspected by experts of an enrichment effort to obtain technologies used to obtain technologies that would be used for tehran in tehran and if the issue is considered the iaea and the european conventions to produce the atomic bomb .”</em></p>

        <p><strong>Sentences that is fluent:</strong></p>
        <p><em>“china and kyrgyzstan pledge to make joint efforts to crack down on terrorism and other threats to regional and global security”</em></p>
        ...
        <p><strong>Sentence that isn’t clear:</strong></p>
        <!--TODO: Find sample-->
        <p><em>
            “officials from iaea and the european conventions were suspected by experts of an enrichment effort to obtain technologies used to obtain technologies that would be used for tehran in tehran and if the issue is considered the iaea and the european conventions to produce the atomic bomb .”</em></p>
