<template>
    <div class="document">
        ...
        <hr/>
        <p>When you have finished, <strong>you need to put in your email to be included for a prize draw of a £15 Amazon voucher. Please take a note that you have to do the task twice by refreshing the page after you have successfully submitted to be eligible for the prize draw.</strong> You can do the task more than twice but not more than 5 times where each submission will raise your chance for the prize draw. We will remove any excess submission from the database.</p>
        <hr/>
