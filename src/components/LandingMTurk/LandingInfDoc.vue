<template>
    <div>
        ...
        <hr/>
        <p>There are two ways to determine that a sentence is informative:</p>
        <blockquote>
            <strong>All important</strong> information is present in the summary
        </blockquote>
        <p>Which in other words states that the summary cover all the important information of the document. However the summary itself might contains information that is not important.</p>
        <blockquote>
            <strong>Only important</strong> information is in the summary.
        </blockquote>
        <p>Which in other words states that all information in the summary is important according to the document.</p>
        <p>A short example where the highlights are important words:</p>
        <blockquote>
        ...
        <strong>All important information in document presents in Summary A, while only important information is in the Summary B.</strong><br/>
