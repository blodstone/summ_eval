...
if __name__ == '__main__':
    app = create_app()
    db = SQLAlchemy(app)
    file_path = '/home/acp16hh/Projects/Research/Experiments/Exp_Elly_Human_Evaluation/mturk/working/Batch_3496679_batch_results.csv'
        ...
        if result:
            ...
            if validity:
               feedback = ''
                ...
                feedback = 'Sorry, but you gave the wrong answer to the statement "%s". The correct answer is %s' % (result[3].sanity_statement_2, result[3].sanity_answer_2)
